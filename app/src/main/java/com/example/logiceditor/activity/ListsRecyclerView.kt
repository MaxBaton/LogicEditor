...
object ListsRecyclerView {
    ...
    val listIconElements = listOf(R.drawable.and_element, R.drawable.or_element, R.drawable.not_elemet,
                                    R.drawable.xor_element, R.drawable.button_off_recycler_view,
