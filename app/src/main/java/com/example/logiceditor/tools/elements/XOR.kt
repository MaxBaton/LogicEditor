...
class XOR(override var image: Int, override var coordinates: Pair<Float, Float> = 200f to 200f):
    ...
    override fun calculate(input1: Boolean, input2: Boolean) = if (!isInversion) (input1 xor input2) else !(input1 xor input2)
    ...
    private fun changeImage() {
        image = if (!isInversion) R.drawable.xor_element else R.drawable.xor_element_not
    }
}